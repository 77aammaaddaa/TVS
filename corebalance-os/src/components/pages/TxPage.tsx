    ...
    <div className="min-h-screen bg-slate-50 pb-24">
      ...
      <div className="p-4">
        <div className="flex justify-between items-center mb-4">
          ...
          <button
            type="button"
            className="bg-white p-2 rounded-lg shadow-sm border border-slate-200 text-slate-600 active:scale-95"
          >
            <Filter size={20} />
          </button>
        </div>
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-slate-100 flex flex-col">
          {filteredTx.length === 0 ? (
            ...
            filteredTx.map((tx, idx) => {
              let iconColorClass = 'bg-blue-50 text-blue-600';
              ...
              return (
                <div key={tx.id || idx} className="flex items-center justify-between p-4 border-b border-slate-50 last:border-0">
                  ...
                  <div className="text-right">
                    <p className={`text-base font-bold ${amountColorClass}`}>
